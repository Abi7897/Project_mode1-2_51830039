...
import com.patient.model.persistance.User;
import com.patient.model.persistance.UserNotFoundException;
import com.patient.model.service.UserService;
...
public class UserMgtController {
	...
	public void init(){
		...
		userService.addUser(new User("karan","karan@g.com","karan123","emp",true));
		userService.addUser(new User("sibu","sibu@g.com","sibu123","admin",true));
		userService.addUser(new User("nibu","nibu@g.com","nibu123","mgr",true));
